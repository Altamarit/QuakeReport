...
public final class QueryUtils {
     ...
     * Sample JSON response for a USGS query
          ...
          "94km SSE of Taron, Papua New Guinea\"    - test ->
     ...
     */
    private QueryUtils(String requestUrl) {
    }
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        try {
            ...
            jsonResponse=fetchEarthquakeData(requestUrl);

            //  get the Json string: the data we need are magniture, location and date.
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                //  each single feature is and earthquake
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);

                //  de details for each earthquake are in object "properties"
